...
const SORT_OPTIONS: { value: SortKey; label: string; sort: string[] }[] = [
  { value: "newest", label: "Neueste zuerst", sort: ["-source.posted_at"] },
  { value: "oldest", label: "\u00c4lteste zuerst", sort: ["source.posted_at"] },
  { value: "score_high", label: "Beste Bewertung", sort: ["-eval_score", "-source.posted_at"] },
  { value: "score_low", label: "Schlechteste Bewertung", sort: ["eval_score", "-source.posted_at"] },
];
